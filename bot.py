...
from tgbot.misc.function import author2_router, alert8,alert12,alert16,start_search
...
async def main():
    ...
    await asyncio.gather(dp.start_polling(bot), dp2.start_polling(bot2), alert8(), alert12(), alert16(), start_search())
